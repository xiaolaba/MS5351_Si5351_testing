...
avr-gcc.exe -mmcu=atmega328p -Os -c main.c -o main.o
avr-gcc.exe -mmcu=atmega328p -Os -c i2c.c -o i2c.o
avr-gcc -mmcu=atmega328p -o main.elf main.o i2c.o
avr-objcopy.exe -O ihex -R .eeprom main.elf main.hex
...
avrdude -c arduino -P com6 -p %mcu% -U flash:w:main.hex:a
